$(document).ready(function() {
    ...
    if ($('#announcement-list').length >= 3) {
        $('#announcement-list-previous,#announcement-list-next').addClass('enabled');
    }
...
function contributors($arg){
    ...
    if ($arg === undefined || $arg == '' || $arg == 'all')
        console.log("%cContributor List\n\n"+"%c--Designed by--"+
        "%c\nAnikalp Jaiswal (anikalpjaiswal1@gmail.com)\n %c--Core Developer--\n%cAnikalp Jaiswal (anikalpjaiswal1@gmail.com)",'color:rgb(163,169,72);text-align:center;font-size:2em','color: rgb(15,108,107);font-size:1.5em;text-align:center','color:rgb(50,50,50);font-size:1.0.5em','color: rgb(15,108,107);font-size:1.5em;','color:rgb(50,50,50);font-size:1.0.5em','color: rgb(15,108,107);font-size:1.5em;','color:rgb(50,50,50);font-size:1.0.5em','color: rgb(15,108,107);font-size:1.2em;','color:rgb(50,50,50);font-size:1.0.5em');
    else if($arg == 'designer' || $arg =='design' || $arg =='designers')
        console.log("%c--Designed by--%c\nAnikalp Jaiswal (anikalpjaiswal1@gmail.com)",'color: rgb(15,108,107);font-size:1.5em;text-align:center','color:rgb(50,50,50);font-size:1.0.5em');
    else if($arg == 'devs' || $arg == 'dev' || $arg == 'developers' || $arg == 'developer')
    console.log("%c--Core Developer--\n%cAnikalp Jaiswal (anikalpjaiswal1@gmail.com)",'color: rgb(15,108,107);font-size:1.5em;','color:rgb(50,50,50);font-size:1.0.5em','color: rgb(15,108,107);font-size:1.5em;','color:rgb(50,50,50);');
    return "Thank You";
}

console.log("Type %c contributor()%c to get list of contributors.\n %carguments(optional):all,devs,designers",'color:rgb(15,108,107)','color:rgb(50,50,50);','color:blue');
